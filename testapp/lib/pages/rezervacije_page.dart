...
List<Rezervacija> listaRezervacijaTest = <Rezervacija>[
  ...
  Rezervacija(
      5,
      DateTime.parse("2021-07-22 15:18:04"),
      DateTime.parse("2021-07-22 16:18:04"),
      'Sala 1',
      'Gradska čitaonica',
      -1,
      true), //-1 znaci da je grupna rezervacija
  Rezervacija(
      5,
      DateTime.parse("2022-03-21 09:00:00"),
      DateTime.parse("2022-03-21 11:55:00"),
      'Sala 1',
      'Gradska čitaonica',
      22,
      true),
