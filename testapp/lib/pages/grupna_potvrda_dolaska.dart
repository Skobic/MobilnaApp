...
class GrupnaPotvrdaDolaska extends StatefulWidget {
  ArgumentiGrupnePotvrdeDolaska argInfo;

  GrupnaPotvrdaDolaska({Key? key, required this.argInfo}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _GrupnaPotvrdaDolaskaState();
}

class _GrupnaPotvrdaDolaskaState extends State<GrupnaPotvrdaDolaska> {
    ...
    if (response?.statusCode == 200 || response?.statusCode == 201) {
      ...
      showDialog<String>(
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          content: const Text(
              'Skenirali ste netačan QR kod, provjerite da li skenirate kod u pravoj sali !',
              style: TextStyle(fontSize: 20)),
          actions: <Widget>[
            TextButton(
              onPressed: () {
